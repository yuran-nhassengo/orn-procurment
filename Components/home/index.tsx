...
export const HomeIntr = () => {
  ...
  return (
    <div className="flex rounded-xl border-2 shadow-xl  bg-gradient-to-r from-gray-900 to-gray-800 text-gray-200 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-cover fit bg-center opacity-30 filter blur-sm" style={{ backgroundImage: 'url("https://static-cse.canva.com/blob/759727/ComoTirareEditarSuaFotoparaPerfilemRedesSociaisfeaturedimagee1559023010630.jpg")' }}></div>
