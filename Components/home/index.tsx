...
export const HomeIntr = () => {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-r from-gray-900 to-gray-800 text-gray-200">
      {/* Seção de texto no lado esquerdo */}
      <div className="flex-1 flex flex-col justify-center items-start p-12 space-y-6">
        <h1 className="text-4xl font-bold text-green-400 animate-ping">Orn Eletróferragem</h1>
